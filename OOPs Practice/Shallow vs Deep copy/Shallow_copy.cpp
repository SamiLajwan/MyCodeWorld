...
int main(){
    ...
    *b.y = 20;
    ...
    // b.print(); 
    // return 0; // while returning since b is in heap memory, it will try to delete b ,
    // but it's content is already deleted as y of bis pointing to y of a -> gives error
}